...
So, grid-template is the shorthand method of grid-template-rows and grid-template-columns. But we have to remember that repeat method of rows will come first and then forward(/) slash and then the repeat method of columns.
